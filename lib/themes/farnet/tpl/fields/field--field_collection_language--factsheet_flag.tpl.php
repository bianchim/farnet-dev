  ...
  <ul class="field-languages">
    <?php foreach ($items as $delta => $item_collection): ?>
      <?php foreach ($item_collection['entity']['field_collection_item'] as $delta => $item): ?>
        <li class="language_level">
          <?php if (!empty($item['field_term_language'])) : ?>
            <?php echo $item['field_term_language'][0]['#markup']; ?>
          <?php endif; ?>
          <?php if (!empty($item['field_language_level'])) : ?>
            <?php echo ' (' . $item['field_language_level'][0]['#markup'] . ')'; ?>
          <?php endif; ?>
        </li>
      <?php endforeach; ?>
    <?php endforeach; ?>
