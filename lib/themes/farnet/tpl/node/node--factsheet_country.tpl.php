  ...
  <?php if (!empty($content['group_factsheet_clld_budget'])) : ?>
    ...
    <div class="highlight--background">
      <?php if (!empty($content['group_factsheet_clld_budget']['field_total_budget'])) : ?>
        ...
        <div class="field-item"><?php print number_format($content['group_factsheet_clld_budget']['field_total_budget']['0']['#markup'], 0, '.', ' '); ?> EUR</div>
      </div>
      <?php endif; ?>
      <ul class="fr-u-ul">
        ...
        <li class="field field-name-field-emff-budget field-label-inline clearfix">
          ...
          <div class="field-items"><?php print number_format($content['group_factsheet_clld_budget']['field_emff_budget']['0']['#markup'], 0, '.', ' '); ?> EUR</div>
        </li>
        <?php endif; ?>
        ...
        <li class="field field-name-field-co-funding field-type-text-long field-label-inline clearfix">
          ...
          <div class="field-item"><?php print number_format($content['group_factsheet_clld_budget']['field_co_funding']['0']['#markup'], 0, '.', ' '); ?> EUR</div>
        </li>
        <?php endif; ?>
        <?php if (!empty($content['group_factsheet_clld_budget']['field_number_flags'])) : ?>
        <li class="field field-name-field-number-flags field-label-inline clearfix">
        ...
        <li class="field field-name-field-average-budget-per-flag field-label-inline clearfix">
          <div class="field-label"><?php print $content['group_factsheet_clld_budget']['field_average_budget_per_flag']['#title']; ?>:&nbsp;</div>
          <div class="field-item"><?php print number_format($content['group_factsheet_clld_budget']['field_average_budget_per_flag']['0']['#markup'], 0, '.', ' '); ?> EUR</div>
        </li>
        <?php endif; ?>
      </ul>
    </div>
