Feature: Factsheet Flag content type
  ...
  Scenario: Access denied to Factsheet Flag form
    ...
    When I go to "node/add/farnet-flag"
  ...
  @api
   Scenario: Create factsheet flag
    ...
    When I visit "node/add/factsheet-flag"
    Then I should see the heading "Create Factsheet Flag"
    When I fill in "title" with "Behat Factsheet Flag Test #1"
    ...
    And I press the "Save" button
    # Then I should see the success message "Factsheet Flag Behat Factsheet Flag Test #1 has been created."
    # And I should see the heading "Behat Factsheet Flag Test #1"
  ...
  Scenario: Edit factsheet flag
    Given I am logged in as a user with the "administrator" role
    When I am viewing an "farnet_factsheet flag" content:
      | title_field                   | Behat Factsheet Flag Test #2           |
    ...
    #Then I should see the heading "Behat Factsheet Flag Test #2"
     #And I click "Edit"
     #And I fill in "Name" with "Behat Factsheet Flag Test #2.1"
     #And I press the "Save" button
  ...
  Scenario: Delete factsheet flag
    Given I am logged in as a user with the "administrator" role
    When I am viewing an "farnet_factsheet flag" content:
      | title_field                 | Behat Factsheet Flag Test #3              |
      | field_farnet_abstract       | Lorem ipsum dolor sit amet abstract.      |
      | field_ne_body               | Lorem ipsum dolor sit amet body.          |
      | moderation state            | published                                 |
      | workbench_moderation_state  | published                                 |
    ...
    # And I attach the file "profiles/multisite_drupal_standard/themes/ec_resp/logo.png" to "edit-field-picture-und-0-upload"
    # And I press "Delete"
    # Then I should see the heading "Are you sure you want to delete Behat Factsheet Flag Test #3?"
    # When I press "Delete"
